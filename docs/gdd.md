...
# ภาคผนวก v11 — "การผงาดแห่งเถ้าธุลี" (The Ashen Ascension)

## 1. การปรับสมดุลศัตรู (Zone-Based Difficulty)
ความยากของศัตรูถูกตรึงไว้กับ **โซน** (dangerTier × ความลึก × ชนิดโหนด) เลเวลผู้เล่นเพิ่มพลังศัตรูเพียง +1.2% ต่อเลเวล และตันที่ +36% — ผู้เล่นที่เก็บเลเวลเกินโซนจะ "บดขยี้" โซนต้นเกมได้จริง ความรู้สึกทรงพลังคือรางวัลของการฟาร์ม

## 2. ระบบอุปกรณ์ 8 ช่อง
อาวุธ / หมวก / เกราะอก / สนับขา / รองเท้า / แหวน / สร้อยคอ / กำไล — เครื่องประดับดรอปยากกว่าอาวุธ-เกราะอย่างมีนัยยะ (ชิ้นละ 5% เทียบกับอาวุธ 25%) บังคับใช้ทั้งของดรอป ร้านค้า และตลาดมืด เซฟเก่า migrate อัตโนมัติโดยไม่เสียของ

## 3. แต้มสังเวียนและศัสตรา ผู้คุมสังเวียนเลือด
ทุกศึก PvP จ่าย **แต้มสังเวียน** (ชนะ 12 / แพ้ 4) นำไปแลก **ชุดเกียรติยศสังเวียน** กับศัสตราในเมืองหลวง — ระดับความแรงอยู่เหนือ Epic แต่ **ไม่มีวัน** แตะระดับสูงสุด ของที่ดีที่สุดยังคงอยู่กับจอมมารแดนลึกและเหตุการณ์ลับของ NPC เท่านั้น

## 4. คลาสลับ (4 คลาส)
ผู้หักคำสาป / อัศวินเถ้าธุลี / ผู้เฝ้าสุสาน / จันทร์คลุมเงา — ปลดล็อกถาวร **ระดับบัญชี** (รอดข้าม permadeath) ผ่านเหตุการณ์ลับ หน้าสร้างตัวละครแสดงเป็นเงาปริศนาพร้อมคำใบ้ปริศนาธรรม

## 5. คลาสเอกอุแห่งเซิร์ฟเวอร์ (10 คลาส — กฎ Highlander)
ราชันสุริยคราส, นักบุญกลวงเปล่า, จักรพรรดินีมหันตโรค, ผู้เกี่ยวสุญตา, ผู้หักรุ่งอรุณ, จอมพลหลุมศพ, ศาสดาอักขระ, ราชาแห่งรัตติกาล, ราชินีเถ้าถ่าน, ผู้ยืน ณ ขอบโลก — ปลดล็อกด้วยชุดเงื่อนไขซับซ้อน **แต่ละคลาสมีผู้ครองได้หนึ่งเดียวทั้งเซิร์ฟเวอร์** (Firestore transaction) ผู้ครองที่สิ้นชีพถาวรในสังเวียนจะถูกริบคลาสคืนสู่บัลลังก์ว่างทันที

## 6. คำสาปสติวิปลาส (ภาษี PvP ช่วงท้ายเกม)
เมื่อถึงเลเวล 25 หรือหยั่งลึกถึงโซนที่ 6 ตัวละครถูกสาปถาวร: ต้องสู้ PvP อย่างน้อย 1 ครั้งทุก 24 ชั่วโมงจริง มิเช่นนั้นเสียหัวใจ 1 ดวงต่อวันที่พลาด (ทบต้นจน permadeath ได้) — แต้มสังเวียนฝั่งแพ้คือกันชนที่ทำให้ภาษีนี้ไม่ลงโทษซ้ำซ้อน

> **หมายเหตุวิศวกรรม:** นาฬิกาคำสาปและการริบคลาสเอกอุตอนตายยังเป็น honest-client — การบังคับใช้จริงต้องย้ายไป Cloud Functions + Security Rules ในเฟส server-authoritative เดียวกับการหักหัวใจและการสุ่มของ
